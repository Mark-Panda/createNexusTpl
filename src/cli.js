...
const buildForSchemaVersionNew = require('./schema');
...
function cli() {
    ...
    if (args['-s']) {
        ...
        buildForSchemaVersionNew(schema, args);
    } else {
...
function help() {
  ...
  --sl       add this option to use @nexus/schema package
  ...
  --cn      add this option to create Queries Connect
